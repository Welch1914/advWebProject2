...
Purpose: This page(allPosts.php) is where the user can view all posts . 
-->
<html>
    <head>
         <title>Blog Post - View All Posts</title>
<?php
...
?>
 ...
 // this div is where all post are listed
echo '<div id="all posts">';
    $query1 = "SELECT * FROM posts ORDER BY date DESC";
